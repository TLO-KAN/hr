...
ALTER TABLE employees ADD COLUMN IF NOT EXISTS first_name_en VARCHAR(255);
ALTER TABLE employees ADD COLUMN IF NOT EXISTS last_name_en VARCHAR(255);
ALTER TABLE employees ADD COLUMN IF NOT EXISTS nickname VARCHAR(255);
